...
const servicesData = [
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Expertise in both front-end and back-end development<br>● SEO-focused design for better rankings<br>● Fully customized solutions, no templates"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Creative, tailored content that resonates<br>● Proven track record of growing engagement<br>● Expertise across all major platforms"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Strong connections with influencers across industries<br>● Focus on authentic, high-impact collaborations<br>● Metrics-driven approach for measurable results"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Data-driven SEO strategies<br>● Comprehensive approach to on-page, off-page, and technical SEO<br>● Focus on organic traffic growth and higher conversions"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Targeted campaigns for maximum impact<br>● Continuous monitoring and optimization<br>● Expertise across PPC, email, and content marketing"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Eye-catching, creative designs<br>● Strong understanding of traditional media<br>● Seamless integration with digital strategies"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Expertise in developing strong brand identities<br>● Tailored designs that capture your brand’s essence<br>● Full-service creative team"
    },
    {
        ...
        description: "Visual content is crucial in today&rsquo;s marketing. We offer professional photoshoot and videoshoot services that create engaging, high-quality visuals to showcase your brand across social media, websites, and more.",
        extraInfo: "Why we&rsquo;re the best:<br>● Professional photographers and videographers<br>● Visually appealing content aligned with your brand<br>● Expertise in producing content for all media types"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● End-to-end event management services<br>● Creative concepts tailored to your brand<br>● Expertise in planning events of all sizes"
    },
    {
        ...
        extraInfo: "Why we&rsquo;re the best:<br>● Tailored solutions for every budget<br>● No compromise on quality, regardless of package size<br>● Transparent pricing and flexible options"
    }
